...
class ConfirmSetTransactionPin extends ConsumerStatefulWidget {
  final String pin;
  const ConfirmSetTransactionPin({super.key, required this.pin});

  @override
  ConsumerState<ConfirmSetTransactionPin> createState() =>
      _ConfirmSetTransactionPinState();
}

class _ConfirmSetTransactionPinState
    extends ConsumerState<ConfirmSetTransactionPin> {
  String enteredPin = '';
  ...
  void onPinComplete() {
    ...
    if (widget.pin != enteredPin) {
      ...
      ref
          ...
          .setPin(ref: ref, newPin: enteredPin, context: context);
    }
  }
