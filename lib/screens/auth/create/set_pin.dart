...
class SetransactionPin extends StatefulWidget {
  ...
  @override
  State<SetransactionPin> createState() => _SetransactionPinState();
}

class _SetransactionPinState extends State<SetransactionPin> {
  String enteredPin = '';
  ...
  void onPinComplete() {
    Navigator.push(
      context,
      MaterialPageRoute(
          builder: (context) => ConfirmSetTransactionPin(
                pin: enteredPin,
              )),
    );
  }
