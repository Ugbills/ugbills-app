...
class GiftcardTransactionDetails extends StatelessWidget {
  final String giftcardLogo,
      amount,
      transactionID,
      dateAndTime,
      usdAmount,
      ...
      fee,
      note;
  const GiftcardTransactionDetails({
    super.key,
    required this.giftcardLogo,
