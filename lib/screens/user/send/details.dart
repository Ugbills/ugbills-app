              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    showDetails("Transaction ID", "#2D94ty823"),
                    showDetails("Date & time", "Mar 10 2023, 2:33PM"),
                    showDetails("Bank Name", "First Bank of Nigeria"),
                    showDetails("Account Name", "Mary Doe"),
                    showDetails("Account Number", "243802003835"),
                    showDetails("Fee", "₦10.00"),
                    showDetails("Note", "None"),
                    const Spacer(),
                    ZeelButton(
